...
export function DashboardChart({ data }: { data: Execution[] }) {
    ...
    return (
        <div className="flex flex-col w-full rounded-2xl border border-white/[0.06] bg-white/[0.01] backdrop-blur-3xl transition-all duration-500 hover:border-white/[0.1] overflow-hidden">
            <div className="p-6 pb-0 flex items-center justify-between">
                <div>
                    <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-neutral-500">
                        Engine Throughput
                    </h3>
                    <p className="text-[11px] text-neutral-600 mt-1">Multi-dimensional execution telemetry.</p>
                </div>
                {/* Visual Legend */}
            ...
            >
                ...
                >
                    ...
                    <CartesianGrid vertical={false} strokeDasharray="4 4" stroke="#ffffff05" />
                    ...
                    <ChartTooltip
                        ...
                        content={<ChartTooltipContent indicator="line" className="bg-neutral-950 border-white/10" />}
                    />
