...
export function FragmentCard({ item }: { item: FloatingItem }) {
  ...
  return (
    ...
    >
      {/* CLIPPED SURFACE */}
      <div
        className="absolute inset-0 border border-white/[0.06] bg-white/[0.02] shadow-[0_10px_40px_rgba(0,0,0,0.6)] backdrop-blur-xl"
      ...
      <div className="relative z-10 flex flex-col gap-3">
        <div className="flex items-center gap-3">
          ...
          <p className="text-[10px] font-bold tracking-widest text-neutral-200 uppercase">
            {item.title}
          </p>
        </div>
