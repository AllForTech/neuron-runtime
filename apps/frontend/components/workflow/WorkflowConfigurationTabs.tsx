...
export function WorkflowConfigurationTabs() {
  ...
  return (
    <Tabs
      defaultValue={CreateWorkflowTabs.general}
      className="container-full flex- flex-col justify-start gap-2"
    >
      <TabsList>
        <TabsTrigger value={CreateWorkflowTabs.general}>General</TabsTrigger>
        <TabsTrigger value={CreateWorkflowTabs.execution}>
          Execution
        </TabsTrigger>
        <TabsTrigger value={CreateWorkflowTabs.runtime}>Runtime</TabsTrigger>
        <TabsTrigger value={CreateWorkflowTabs.advanceSetting}>
          Advance Settings
        </TabsTrigger>
      </TabsList>
