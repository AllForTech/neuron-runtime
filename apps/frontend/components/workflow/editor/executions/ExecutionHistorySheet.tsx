        ...
        {selectedExecutionId ? (
          ...
          <div className="space-y-4">
            ...
            {sortedExecutions.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-neutral-800 bg-neutral-900/10 py-20">
                <Activity className="mb-3 h-8 w-8 text-neutral-800" />
