...
export function convertFieldInputToSchema(
  fields: FieldInput[]
    ...
    if (field.type === 'object') {
      schema[field.name] = {
        ...
        children: field.children
          ? convertFieldInputToSchema(field.children)
          : {},
      };
      ...
      schema[field.name] = {
        ...
        arrayItem: field.arrayItem
          ? field.arrayItem.type === 'object'
            ? {
                type: 'object',
                children: convertFieldInputToSchema(
                  field.arrayItem.children || []
                ),
              }
...
export const getNodeColor = (type: NodeType | string) => {
  const colors: Record<
    string,
    { border: string; bg: string; text: string; primary: string }
  > = {
    trigger: {
...
function getVaultKey(): Buffer {
  const secret =
    ...
    '9e6cc1953e576e2d687083223d49fba1b1e11dbfb1d1629f8d4f7c7800859ef9';
  if (!secret) {
...
export const getNodeValidationStyles = (
  nodeError: WorkflowNodeError | null
) => {
