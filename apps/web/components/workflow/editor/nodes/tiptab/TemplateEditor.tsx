...
import {
  VariableNode,
  VariableSuggestion,
} from '@/components/workflow/editor/nodes/tiptab/variableNode';
...
export default function TemplateEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'min-h-[32px] px-2 py-1 text-xs text-neutral-200 bg-neutral-950 border border-neutral-800 rounded-md focus:outline-none focus:border-neutral-700 transition-colors',
      },
    },
    onUpdate({ editor }) {
