...
interface InspectorProps {
    ...
    className?: string;
    width?: string;
    withOverlay?: boolean; // New prop for the overlay
}
            ...
            {open && (
                <>
                    ...
                    <motion.div
                        ...
                        // Bumped Z-index to 9999 to sit above the overlay and all other UI
                        className={cn(
                            'fixed z-[9999]! flex h-[80dvh] w-[300px] flex-col overflow-hidden',
