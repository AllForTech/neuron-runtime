  ...
  return (
    ...
    >
      <div className="mt-6 space-y-6">
        <div className="rounded-lg border border-neutral-800/50 bg-neutral-900/40 p-3 backdrop-blur-sm">
          <p className="mb-3 text-[10px] font-bold tracking-tight text-neutral-500 uppercase">
            Logic Rule
          </p>
        ...
        <div className="px-1">
          <p className="text-[11px] text-neutral-400 italic">
            Tip: Use double curly braces{' '}
            <code className="text-primary/80">{'{{ }}'}</code> to reference data
            from upstream nodes.
          </p>
        </div>
      </div>
