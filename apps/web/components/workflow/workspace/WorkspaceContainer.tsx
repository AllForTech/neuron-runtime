...
export const WorkspaceContainer = ({
    ...
    const unassignedWorkflows = useMemo(() => {
        return workflows ? workflows.filter(wf => !assignedWorkflowIds.has(wf.id) || wf.workspaceId === null) : [];
    ...
    return (
        <DndContext sensors={sensors} onDragEnd={handleDragEnd}>
            <div className="flex flex-col gap-12 pt-0!">
                {/* --- Workspace Grid --- */}
                <div className={cn(
                    "grid grid-cols-1 gap-8 md:px-4 sm:grid-cols-2 lg:grid-cols-3 transition-all duration-500",
...
const UnassignedDropZone = ({ workflows, onCardClick, deleteWorkflow }: any) => {
    ...
    return (
        ...
        >
            ...
            <div className="grid mt-6 md:mt-10! grid-cols-1 min-h-[100px] gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
